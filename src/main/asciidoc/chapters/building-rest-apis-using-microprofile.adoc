...
Download and install Postman (https://www.getpostman.com). When you have done that open it and we will test our api.
...
Open Postman and try both the Update and Delete functions.

Here, I will update the Book with id 51 and if you don’t have Book object with id 51 then take one that you have in your database, now if you get all objects again you will see that the object is updated.
Next is to try the DELETE method, open a new Postman tab and make it look like below image.
