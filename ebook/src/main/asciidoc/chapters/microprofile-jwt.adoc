...
Now type type following command to start the Keycloak server:
...
open you browser and navigate to http://localhost:8080/auth/ and create a new user with admin access.
...
* Klick on `Groups` and create a new group called `mysimpleservice`
